<div class="space-y-3">
    ...
    @if($currentLogFile)
        <div class="flex items-center gap-2 text-xs text-gray-500 dark:text-gray-400">
            ...
            Showing stats for: <span class="font-medium text-indigo-600 dark:text-indigo-400">{{ $currentLogFile }}</span>
        </div>
    @endif
    ...
    <div class="grid grid-cols-2 md:grid-cols-5 xl:grid-cols-10 gap-3">
        ...
        $cards = [
            ...
            ['label' => 'Cache',      'value' => $cacheErrors,      'color' => 'pink',   'icon' => 'M5 12h14M5 12a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v4a2 2 0 01-2 2M5 12a2 2 0 00-2 2v4a2 2 0 002 2h14a2 2 0 002-2v-4a2 2 0 00-2-2'],
            ['label' => 'Other',      'value' => $otherErrors,      'color' => 'slate',  'icon' => 'M5 8h14M5 8a2 2 0 110-4h14a2 2 0 110 4M5 8v10a2 2 0 002 2h10a2 2 0 002-2V8m-9 4h4'],
        ...
        $colorMap = [
            ...
            'pink'   => ['bg' => 'bg-pink-50 dark:bg-pink-900/20',     'text' => 'text-pink-700 dark:text-pink-300',     'icon' => 'text-pink-500'],
            'slate'  => ['bg' => 'bg-slate-50 dark:bg-slate-700/40',   'text' => 'text-slate-700 dark:text-slate-300',   'icon' => 'text-slate-500'],
